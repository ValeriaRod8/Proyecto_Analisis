...
import 'dashboard_poolman_model.dart';
export 'dashboard_poolman_model.dart';

class DashboardPoolmanWidget extends StatefulWidget {
  const DashboardPoolmanWidget({Key? key}) : super(key: key);

  @override
  _DashboardPoolmanWidgetState createState() => _DashboardPoolmanWidgetState();
}

class _DashboardPoolmanWidgetState extends State<DashboardPoolmanWidget>
    with TickerProviderStateMixin {
  late DashboardPoolmanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardPoolmanModel());
